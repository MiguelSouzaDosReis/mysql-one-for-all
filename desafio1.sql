...
CREATE TABLE SpotifyClone.usuarios(
    ...
    FOREIGN KEY (plano_id) REFERENCES economia(plano_id)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.artistas_seguidos (usario_id, artista_id)
VALUES
  (1,1),
  (1,4),
  (1,3),
...
INSERT INTO SpotifyClone.historicos (usario_id, historico_de_reproducoes, data_reproducao)
VALUES
  ...
  (2,"Finding My Traditions" ,'2020-01-02 07:40:33'),
